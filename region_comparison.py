...
def main():
	...
	regions = ['Northern America', 'South America', 'Central America', 'Northern Europe', 'Western Europe', 'Southern Europe', 'Eastern Europe', 'South-Eastern Asia',
			   'Western Asia', 'Southern Asia', 'Eastern Asia', 'Southern Africa', 'Eastern Africa', 'Northern Africa', 'Western Africa', 'Australia and New Zealand']

	regions_abbrv = ['N-AME', 'S-AME', 'C-AME', 'N-EUR', 'W-EUR', 'S-EUR', 'E-EUR', 'SE-ASIA', 'W-ASIA', 'S-ASIA', 'E-ASIA', 'S-AFR', 'E-AFR', 'N-AFR', 'W-AFR', 'ANZ']
	...
	p = figure(x_range=regions_abbrv, y_range=(0, 400), plot_height=250, plot_width=1000, title="University count per region per year",
