...
plot2016 = figure(plot_width = 600, plot_height = 600, title ='Amount of universities with certain overall grades 2016',
x_axis_label ='Overall grade', y_axis_label = 'Amount of universities')

plot2017 = figure(plot_width = 600, plot_height = 600, title ='Amount of universities with certain overall grades 2017',
x_axis_label ='Overall grade', y_axis_label = 'Amount of universities')
