...
def update_bar_chart():
    ...
    source.data = source.from_df(data[['region', 'list2016', 'list2017', 
                                       'list2018']])
...
# set up plots
source = ColumnDataSource(data=dict(region=[], list2016=[],
                                    list2017=[], list2018=[]))
